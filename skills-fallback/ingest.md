...
3. **Summary page** — Create or update `wiki/sources/<slug>.md` with key takeaways and links to entities/concepts.
4. **Integrate** — Update every affected entity/concept page in `wiki/`. Strengthen or challenge existing synthesis. Flag contradictions.

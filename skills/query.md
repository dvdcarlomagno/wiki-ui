...
5. If the answer is a durable synthesis (comparison, decision memo, recurring FAQ), file it under `wiki/` as a flat kebab-case page (e.g. `wiki/answer-<slug>.md`), update `index.md`, and append a query entry to `log.md`. Do not create new subfolders unless the human asks.
